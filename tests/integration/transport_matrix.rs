...
//!
//! Each explicit behavior module invokes [`transport_test!`] to generate
...
mod core_lifecycle {
    ...
    transport_test!(noop, |h| async move {
        let client = h.client();
...
mod remember_many_and_admin_count {
    use super::*;
...
mod scope_registry_context_hints {
    use super::*;
...
mod admin_reassign_scope_updates_read_metadata {
    use super::*;
...
mod validation_errors_are_transport_consistent {
    use super::*;
...
mod remember_many_validation_is_all_or_nothing {
    use super::*;
...
mod recall_uses_embeddings_when_available {
    use super::*;

    transport_test!(embedding, |h| async move {
        let client = h.client();
...
mod revise_content_triggers_reembedding {
    use super::*;
