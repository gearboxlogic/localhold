...
use crate::structure::syntax::{ProductionCfgContext, PublicReexportEvidence, TypeDeclarationEvidence};
...
fn declaration_applies_to_impl(declaration: &TypeDeclarationEvidence, target_item: &[String], target_cfg: &ProductionCfgContext) -> bool {
    declaration.item_path == target_item && declaration.cfg.conjoin(target_cfg).is_some()
}
