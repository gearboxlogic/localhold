...
pub(super) const GATE_RUNNER_ENVIRONMENT_LINES: &[&str] = &[
    ...
    "    for name in BASH_ENV ENV COMPILER_PATH GCC_EXEC_PREFIX GCONV_PATH GITHUB_PATH LD_AUDIT LD_LIBRARY_PATH LD_PRELOAD OPENSSL_CONF OPENSSL_CONF_INCLUDE OPENSSL_ENGINES OPENSSL_MODULES PERL5LIB PERL5OPT PERLLIB RIPGREP_CONFIG_PATH RUSTFLAGS RUSTDOCFLAGS CARGO_ENCODED_RUSTFLAGS CARGO_ENCODED_RUSTDOCFLAGS RUSTC_BOOTSTRAP CLIPPY_CONF_DIR GIT_DIR RUSTC_WRAPPER \\",
...
pub(super) const CI_TRUST_ENVIRONMENT_LINES: &[&str] = &[
    ...
    "          RUSTUP_UPDATE_ROOT: https://static.rust-lang.org/rustup",
    "  LOCALHOLD_MAINTAINABILITY_BOOTSTRAP_SHA256: 3187c553c87463aef13902364ef9257f2f719a8886dc48cd69a41b4a24728751",
