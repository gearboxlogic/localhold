...
pub(super) const GATE_RUNNER_ENVIRONMENT_LINES: &[&str] = &[
    ...
    "    for name in BASH_ENV ENV GCONV_PATH GITHUB_PATH LD_AUDIT LD_LIBRARY_PATH LD_PRELOAD OPENSSL_CONF OPENSSL_CONF_INCLUDE OPENSSL_ENGINES OPENSSL_MODULES RIPGREP_CONFIG_PATH RUSTFLAGS RUSTDOCFLAGS CARGO_ENCODED_RUSTFLAGS CARGO_ENCODED_RUSTDOCFLAGS RUSTC_BOOTSTRAP CLIPPY_CONF_DIR GIT_DIR RUSTC_WRAPPER \\",
...
pub(super) const CI_TRUST_ENVIRONMENT_LINES: &[&str] = &[
    ...
    "          RUSTUP_UPDATE_ROOT: https://static.rust-lang.org/rustup",
    "  LOCALHOLD_MAINTAINABILITY_BOOTSTRAP_SHA256: 8744f984b7c72a4a662b0beeb2700063b7d069eb63bcb105cbabad6ebd0f1671",
